  ...
  const submitReg = async (e) => {
    ...
    if (
      ...
      try {
        ...
        const storageRef = ref(storage, `${userData.name + date}`);

        await uploadBytesResumable(storageRef, Add).then(() => {
    ...
    <div className="outerMain d-flex justify-content-center align-items-center">
      <div className="container  h-75 d-flex justify-content-center align-items-center">
        <div className="main-login-form bg-white h-100">
          <h2 className="p-4 text-center" style={{ color: "red", fontWeight: 400 }}>
            Sign Up
          </h2>
          <form onSubmit={submitReg} className="d-flex align flex-column align-items-center">
            <div className="bg-danger w-75 text-white ">{errMsg}</div>
            ...
            <div className="d-flex align-items-center">
              ...
              <a>
                <img
                  className="p-2"
                  src={require("../assets/images/akar-icons_facebook-fill.png")}
                />
              </a>
            </div>
            <p className="mt-3">
